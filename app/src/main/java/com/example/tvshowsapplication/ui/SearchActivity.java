...
import com.example.tvshowsapplication.databinding.ActivitySearchBinding;
import com.example.tvshowsapplication.listeners.TVShowListener;
import com.example.tvshowsapplication.models.TVShow;
import com.example.tvshowsapplication.viewmodels.SearchViewModel;
        ...
        viewModel.searchTVShow(query, currentPage).observe(this, tvShowsResponse -> {
            ...
            if (tvShowsResponse != null) {
                ...
                if (tvShowsResponse.getTvShows() != null) {
                    ...
                    tvShowsAdapter.notifyItemRangeInserted(oldCount, tvShowsResponse.getTvShows().size());
                }
            }
        });
    }
